...
public class CheckoutOrderTest {
	...
	void oValorDoCheckoutOrderDeveSerIgualASomaDosSeusOrderItem() {
		...
		items.add(createOrderItem(2, BigDecimal.valueOf(55.00)));   // 2 * 55.00 = 110.00
		items.add(createOrderItem(5, BigDecimal.valueOf(20.00)));   // 5 * 20.00 = 100.00
		items.add(createOrderItem(4, BigDecimal.valueOf(40.00))); // 4 * 40.00 = 160.00
	...
	private OrderItem createOrderItem(Integer amount, BigDecimal productPrice) {
